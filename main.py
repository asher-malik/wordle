...
class Keyboard(ttk.Frame):
    def __init__(self, parent, wordleframe):
        ...
        self.q_button = ttk.Button(self.top_frame, text='Q', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.q_button), takefocus=False)
        self.w_button = ttk.Button(self.top_frame, text='W', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.w_button), takefocus=False)
        self.e_button = ttk.Button(self.top_frame, text='E', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.e_button), takefocus=False)
        self.r_button = ttk.Button(self.top_frame, text='R', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.r_button), takefocus=False)
        self.t_button = ttk.Button(self.top_frame, text='T', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.t_button), takefocus=False)
        self.y_button = ttk.Button(self.top_frame, text='Y', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.y_button), takefocus=False)
        self.u_button = ttk.Button(self.top_frame, text='U', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.u_button), takefocus=False)
        self.i_button = ttk.Button(self.top_frame, text='I', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.i_button), takefocus=False)
        self.o_button = ttk.Button(self.top_frame, text='O', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.o_button), takefocus=False)
        self.p_button = ttk.Button(self.top_frame, text='P', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.p_button), takefocus=False)

        self.a_button = ttk.Button(self.mid_frame, text='A', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.a_button), takefocus=False)
        self.s_button = ttk.Button(self.mid_frame, text='S', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.s_button), takefocus=False)
        self.d_button = ttk.Button(self.mid_frame, text='D', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.d_button), takefocus=False)
        self.f_button = ttk.Button(self.mid_frame, text='F', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.f_button), takefocus=False)
        self.g_button = ttk.Button(self.mid_frame, text='G', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.g_button), takefocus=False)
        self.h_button = ttk.Button(self.mid_frame, text='H', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.h_button), takefocus=False)
        self.j_button = ttk.Button(self.mid_frame, text='J', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.j_button), takefocus=False)
        self.k_button = ttk.Button(self.mid_frame, text='K', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.k_button), takefocus=False)
        self.l_button = ttk.Button(self.mid_frame, text='L', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.l_button), takefocus=False)
        ...
        self.back_button = ttk.Button(self.bottom_frame, bootstyle=LIGHT, style='my.TButton', image=self.scaled_back_img, command=self.wordleframe.delete_char, takefocus=False)
        self.z_button = ttk.Button(self.bottom_frame, text='Z', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.z_button), takefocus=False)
        self.x_button = ttk.Button(self.bottom_frame, text='X', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.x_button), takefocus=False)
        self.c_button = ttk.Button(self.bottom_frame, text='C', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.c_button), takefocus=False)
        self.v_button = ttk.Button(self.bottom_frame, text='V', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.v_button), takefocus=False)
        self.b_button = ttk.Button(self.bottom_frame, text='B', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.b_button), takefocus=False)
        self.n_button = ttk.Button(self.bottom_frame, text='N', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.n_button), takefocus=False)
        self.m_button = ttk.Button(self.bottom_frame, text='M', bootstyle=LIGHT, style='my.TButton', command=lambda :self.letters_typed(self.m_button), takefocus=False)
        self.enter_button = ttk.Button(self.bottom_frame, text='Enter', bootstyle=LIGHT, style='my.TButton', command=self.wordleframe.enter_method, takefocus=False)
